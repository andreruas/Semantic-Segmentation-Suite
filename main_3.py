...
model_checkpoint_name = "checkpoints_3/latest_model_" + args.model + "_" + args.dataset + ".ckpt"
...
if args.mode == "train":
    ...
    for epoch in range(0, args.num_epochs):
        ...
        if not os.path.isdir("%s/%04d"%("checkpoints_3",epoch)):
            os.makedirs("%s/%04d"%("checkpoints_3",epoch))
...
####################################################################################################################################
        ...
        # Create directories if needed
        if not os.path.isdir("%s"%("checkpoints_3/Val")):
                os.makedirs("%s"%("checkpoints_3/Val"))

        target=open("%s/train_scores.csv"%("checkpoints_3/Val"),'a')
        if (epoch == 0):
...
##############################################################################################################################
        ...
        if 1:
            ...
            target_avg=open("%s/val_scores.csv"%("checkpoints_3/Val"),'a')
            if (epoch == 0):
